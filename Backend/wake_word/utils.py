    ...
    def __init__(self,
        ...
        if inference_framework == "onnx":
            ...
            if melspec_model_path == "":
                melspec_model_path = os.path.join(pathlib.Path(__file__).parent.resolve(), "models", "melspectrogram.onnx")
            if embedding_model_path == "":
                embedding_model_path = os.path.join(pathlib.Path(__file__).parent.resolve(), "models", "embedding_model.onnx")
